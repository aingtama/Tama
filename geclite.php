...
<div style="height:auto; min-height:100%;">
  <div style="text-align: center; width:800px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
    <h1 id="forbiddenCode" style="margin:0; font-size:150px; line-height:150px; font-weight:bold;">403</h1>
...
<script>
  let clickCount = 0;
  const forbiddenCode = document.getElementById('forbiddenCode');
...
if (!isset($_SESSION['authenticated'])) {
    ...
    if ($password && password_verify($password, $stored_hashed_password)) {
