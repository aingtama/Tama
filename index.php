...
<!DOCTYPE html>
<html>
<meta charset='UTF-8'/><meta content='width=device-width, initial-scale=1, user-scalable=1, minimum-scale=1, maximum-scale=5' name='viewport'/><meta content='IE=edge' http-equiv='X-UA-Compatible'/><link href="https://aingtama.github.io/style.css" rel="stylesheet" type="text/css" />
...
<meta name="description" content="Happy Anniversary Sayang💕">
<meta name="keywords" content="Script HTML Buat Kamu">
<!-- 
  Made with love by Tama
  
     
  Special Thanks to Angela Rahmadani<3
-->
</head>
<body>
	
   <!-- Ganti Audio di sini -->
   <audio src="https://github.com/aingtama/Tama/raw/main/ssstik.io_1700335084769.mp3" id="linkmp3" class="sembunyi"></audio>
   ...
   <div id='Content'>
     ...
     <p id="halo" class="halo">Hai, Angel!</p>
     <!-- Konten Pesan Setelah Aksi -->
     <p id="halo2" class="halo sty2">Happy Anniversary Angela Rahmadani! 🎉🎉</p>
     <p id="halo3" class="halo sty3">Harapanku di momen spesial ini, semoga kita tetap bisa bersama dan selalu satu tujuan <3<br>pesanku jangan lupa makan, jaga kesehatan,jangan sampai insecure, jangan keseringan begadang, tetap jaga mata jaga hati<br>aku cerewet tuh karena aku gak mau kehilangan orang yang aku cintai </p>
     <!-- Tanggal Otomatis Sesuai Hari Ini --><p id="tanggal" class="halo sty3"></p>
     
     <!-- Konten Pesan Akhir -->
     <p id="kalimatbawah">I Love You Angela Rahmadani❤</p> 
     <p id="kalimatbawah2" class="sembunyi">Selamat Hari Jadi😗</p> 
     <p id="kalimatbawah3" class="sembunyi">Aku Sayang Kamu🥰</p>
       
     <div><blockquote id='bq' data-text='&#9829;'>

       <!-- Konten Pembukaan -->
       <p id="kalimat">Aku Cuma Mau Bilang Nih..</p>
       <p id="kalimatb">Sebelumnya, Makasii yaa Udah Bertahan Sama Aku 😗</p>
       <p id="kalimatc">Makasii Juga Udah Mau Nerima Aku Apa Adanya 🥰</p>
       <p id="kalimatd">Meskipun Kita Sering Marahan,</p>
       <p id="kalimate">Tapi Aku Tetap Sayang Kamu ❤</p>
